jQuery(document).ready(function($){
	...
	$("#btn_cuerpo_movimiento").click(function() {
	...
	$("#btn_iniciar_curso").click(function(){
		$("#div-sel-modulo-danza").show();
		$("#div-encabezado-info-aula-danza").hide();
		$("#div-info-aula-danza").hide();
	});

	$("#div-info-aula-danza button").click(function(){
...
$("#div-btn-inicio-danza button").click(function(){
...
$(".dropdown-menu").on('click', 'button', function() {
	...
	switch($(this).attr("id")){
		case "btn-modulo-conexion-danza":
		window.location.href = blog_info+"/aula-danza";
		break;
	}
});
...
$(".div-modulos button").click(function(){
	...
	if($(this).attr('id') == "btn-mod-reconocimiento"){
	...
	if($(this).attr('id') == "btn-mod-movimientos"){
	...
	if($(this).attr('id') == "btn-mod-equilibrio"){
	...
	if($(this).attr('id') == "btn-mod-direcciones"){
