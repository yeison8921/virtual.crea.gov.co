jQuery(document).ready(function($){
	...
	$("#div-btn-mod-mus").on('click', 'button', function() {
		...
		if($(this).attr('id') == "btn-instrumentos"){
			...
			$("#div-imgs-instrumentos").show();
			$("#div-tex-instrumentos").hide();
	...
	function infoBasicaInstrumentos(){
		...
		$("#img-guaracha").attr("src", $("#bloginfo").val() + "/musica/images/guabina/guaracha.png")
	...
	function InfoBasicaBambuco(){
		...
		$("#div-img-bambuco img").css('height', "").addClass('img-responsive');
	...
	$("#div-con-guabina").on('click', 'button', function() {
		...
		switch($(this).attr('id')) {
			...
			$("#div-tex-guabina a").attr("href", $("#bloginfo").val() + "/musica/images/guabina/melodia_la_ruana.png");
			...
			$("#div-tit-guabina h2").text("LA RUANA");
			$("#div-tex-guabina a").attr("href", $("#bloginfo").val() + "/musica/images/guabina/armonia_la_ruana.png");
	...
	$("#div-con-pasillo").on('click', 'button', function() {
		...
		switch($(this).attr('id')) {
			...
			$("#div-tex-pasillo a").attr("href", $("#bloginfo").val() + "/musica/images/pasillo/cachipay_1.jpg");
			$("#div-tex-pasillo img").attr("src", $("#bloginfo").val() + "/musica/images/pasillo/cachipay_1.jpg");
			$("#div-img-pasillo img").css("height", "300px");
			$("#div-img-pasillo a").attr("href", $("#bloginfo").val() + "/musica/images/pasillo/cachipay_2.jpg");
	...
	$("#div-con-bambuco").on('click', 'button', function() {
		...
		switch($(this).attr('id')) {
			...
			$("#div-tex-bambuco").removeClass().addClass('col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6');	
			$("#div-tex-bambuco img").attr("src", $("#bloginfo").val() + "/musica/images/bambuco/golpes.png");
			break;
			case "btn-melodia-bambuco":
			$("#div-tex-bambuco").removeClass().addClass('col-lg-6 col-md-6');	
			$("#div-tit-bambuco h2").text("MELODÍA Y ARMONÍA");
			$("#div-tex-bambuco a").attr("href", $("#bloginfo").val() + "/musica/images/bambuco/bochica_melodia_y_cifra_1.jpg");
			$("#div-tex-bambuco img").css("height", "300px");
			$("#div-tex-bambuco img").attr("src", $("#bloginfo").val() + "/musica/images/bambuco/bochica_melodia_y_cifra_1.jpg");
