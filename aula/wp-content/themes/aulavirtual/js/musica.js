jQuery(document).ready(function($){
	 ...
	 * @param  {[number]} CantidadBotones  [Número para pintar la cantidad de botones de en la sala teórica]
	 ...
	 */
	 ...
	 function infoSalaTeorica(title, mainText, secText, grid, CantidadBotones, botonHover, data){
	 	$(".titulo-info-basica-musica").html("").html(title);
	 	if(grid == 1){
	 	...
	 	if(CantidadBotones == 2){
	 		$("#div-subbotones-sala").html("").html("<div class='col-lg-offset-2 col-lg-3 col-md-offset-2 col-md-3'>"+
	 			"<button class='btn btn-block btn-n-mus' id='btn-ritmo' data-sala-genero=''>Ritmo</button>"+
	 			"</div>"+
	 			"<div class='col-lg-offset-2 col-lg-3 col-md-offset-2 col-md-3'>"+
	 			"<button class='btn btn-block btn-n-mus' id='btn-melodia' data-sala-genero=''>Melodía y Armonía</button>"+
	 			"</div>");
	 	}else{
	 		$("#div-subbotones-sala").html("").html("<div class='col-lg-offset-2 col-lg-2 col-md-offset-2 col-md-2'>"+
	 			...
	 			"<button class='btn btn-block btn-n-mus' id='btn-melodia' data-sala-genero=''>Melodía</button>"+
	 			"</div>"+
	 			"<div class='col-lg-offset-1 col-lg-2 col-md-offset-1 col-md-2'>"+
	 			"<button class='btn btn-block btn-n-mus' id='btn-armonia' data-sala-genero=''>Armonía</button>"+
	 			"</div>");
	 	}
	 	if(botonHover != ""){
	 	...
	 	switch($(this).attr('id')){
	 		...
	 		if($(this).attr("data-sala") == "teorica"){
	 			infoSalaTeorica("La Guabina", "<p>Aire andino de origen campesino, al parecer nacido en Antioquia desde los albores del siglo XIX, con ascendencia europea y con adaptaciones regionales muy sugerentes. Sobre su nombre no existe definición; se habla de la existencia de un pez guabina en los Llanos, y muy apreciado en Cuba por su carne.</p>"+
	 				...
	 				"<h3>Cucharas</h3><p>Es un instrumento que nace a partir de la necesidad de la creación de diferentes sonoridades musicales; éstas son empleadas como instrumento de percusión.</p>", 1, 3, "", "teorica-guabina");
	 		}
	 		break;
	 		case "btn-pasillo":
	 		if($(this).attr("data-sala") == "teorica"){
	 			infoSalaTeorica("El Pasillo", "<p>Este es otro de los bailes folclóricos andinos que se hicieron populares en el siglo XIX. Es una de las variantes del vals europeo, convertido en aire de pasillo, por su ritmo más rápido.</p>"+
	 				...
	 				"CRUZ GONZÁLEZ, Miguel A.: Folclore, Música y Nación. El papel del bambuco en la construcción de lo colombiano. NOMADAS (COL.) núm. 17,2002, pp.222. Universidad Central. Bogotá, Colombia.</p>", "", 2, 2, $(this).attr("id"), "teorica-pasillo");
	 		}
	 		break;
	 		case "btn-bambuco":
	 		if($(this).attr("data-sala") == "teorica"){
	 		...
	 		if($(this).attr("data-sala-genero") == "teorica-guabina"){
	 			infoSalaTeorica("Ritmo Tiple", "<p><div class='embed-responsive embed-responsive-16by9'>"+
	 				...
	 				"<button class='btn btn-block btn-n-mus' id='btn-guitarra' data-genero-sonido='guabina-ritmo'>Guitarra</button>", 2, 3, $(this).attr("id"), "teorica-guabina");
	 		}
	 		if($(this).attr("data-sala-genero") == "teorica-pasillo"){
	 			infoSalaTeorica("Ritmo Pasillo Tiple", "<p><div class='embed-responsive embed-responsive-16by9'>"+
	 				...
	 				"<button class='btn btn-block btn-n-mus' id='btn-guitarra' data-genero-sonido='pasillo-ritmo'>Guitarra</button>", 2, 2, $(this).attr("id"), "teorica-pasillo");
	 		}
	 		if($(this).attr("data-sala-genero") == "teorica-bambuco"){
	 			infoSalaTeorica("Ritmo Bambuco Tiple", "<p><div class='embed-responsive embed-responsive-16by9'>"+
	 				...
	 				"<button class='btn btn-block btn-n-mus' id='btn-guitarra' data-genero-sonido='bambuco-ritmo'>Guitarra</button>", 2, 2, $(this).attr("id"), "teorica-bambuco");
	 		}
	 		break;
	 		case "btn-melodia":
	 		if($(this).attr("data-sala-genero") == "teorica-guabina"){
	 			infoSalaTeorica("Melodía - Voz", "<p><div class='embed-responsive embed-responsive-16by9'>"+
	 				...
	 				"<button class='btn btn-block btn-n-mus' id='btn-bandola' data-genero-sonido='guabina-melodia'>Bandola</button>", 2, 3, $(this).attr("id"), "teorica-guabina");
	 		}
	 		if($(this).attr("data-sala-genero") == "teorica-pasillo"){
	 		...
	 		if($(this).attr("data-sala-genero") == "teorica-guabina"){
	 			infoSalaTeorica("Armonía - Guitarra", "<p>video</p>",
	 				...
	 				"<button class='btn btn-block btn-n-mus' id='btn-guitarra' data-genero-sonido='guabina-armonia'>Guitarra</button>", 2, 3, $(this).attr("id"), "teorica-guabina");
	 		}
	 		break;
	 		case "btn-tiple":
	 		...
	 		if($(this).attr("data-genero-sonido") == "guabina-ritmo"){
	 			infoSalaTeorica("Ritmo guitarra", "<p>video</p>",
	 				...
	 				"<button class='btn btn-block btn-h-mus' id='btn-guitarra' data-genero-sonido='guabina-ritmo'>Guitarra</button>", 2, 3, $(this).attr("id"), "teorica-guabina");
	 		}
	 		if($(this).attr("data-genero-sonido") == "guabina-armonia"){
	 			infoSalaTeorica("Armonía - Guitarra", "<p><div class='embed-responsive embed-responsive-16by9'>"+
	 				...
	 				"<button class='btn btn-block btn-h-mus' id='btn-guitarra' data-genero-sonido='guabina-armonia'>Guitarra</button>", 2, 3, $(this).attr("id"), "teorica-guabina");
	 		}
	 		if($(this).attr("data-genero-sonido") == "pasillo-ritmo"){
	 			infoSalaTeorica("Ritmo Pasillo Guitarra", "<p>video</p>",
	 				...
	 				"<button class='btn btn-block btn-h-mus' id='btn-guitarra' data-genero-sonido='pasillo-ritmo'>Guitarra</button>", 2, 2, $(this).attr("id"), "teorica-pasillo");
	 		}
	 		if($(this).attr("data-genero-sonido") == "bambuco-ritmo"){
	 			infoSalaTeorica("Ritmo Bambuco Tiple", "<p>video</p>",
	 				...
	 				"<button class='btn btn-block btn-h-mus' id='btn-guitarra' data-genero-sonido='bambuco-ritmo'>Guitarra</button>", 2, 2, $(this).attr("id"), "teorica-bambuco");
	 		}
	 		break;
	 		case "btn-voz":
	 		infoSalaTeorica("Melodía - Voz", "<p><div class='embed-responsive embed-responsive-16by9'>"+
	 		...
	 		infoSalaTeorica("Bandola - Voz", "<p>video</p>"+
	 			...
	 			"<button class='btn btn-block btn-h-mus' id='btn-bandola' data-genero-sonido='guabina-melodia'>Bandola</button>", 2, 3, $(this).attr("id"), "teorica-guabina");
	 		break;
	 		case "btn-regresar":
