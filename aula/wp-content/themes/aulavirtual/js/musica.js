jQuery(document).ready(function($){
	$("#div-cim").on("click", "button", function(){
		switch($(this).attr('id')){
			...
			$("#div-tcp").html("").html("Introducción");
			$("#div-icp").html("").html("¡Bienvenidos! En estas salas encontrarán herramientas prácticas que les ayudarán a conocer los ritmos de la música colombiana. Escuchando, tocando e interactuando.");
			break;
			case "btn-objetivos":
			$("#div-tcp").html("").html("Objetivos");
			$("#div-icp").html("").html("<ol>"+
			...
			$("#div-tcp").html("").html("Metodología");
			$("#div-icp").html("").html("<p>En estos salones interactivos, se abordará la música en dos aspectos:</p>"+
				"<ul>"+
				"<li>Teórico</li>"+
				"<li>Práctico</li>"+
				"</ul>"+
			...
			break;
			case "btn-publico":
			$("#div-tcp").html("").html("Nuestro público");
			$("#div-icp").html("").html("<p>Los contenidos del aula virtual están dirigidos a:</p>"+
				"<ul>"+
